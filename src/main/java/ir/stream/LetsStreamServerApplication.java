...
public class LetsStreamServerApplication {
    ...
    public CommandLineRunner run(UserService userService, RoleService roleService, UserRoleService userRoleService,
        ...
        return args -> {
            ...
            Room room0 = new Room("temp", user1, true, false, new HashSet<>(), new HashSet<>());
            Room room1 = new Room("temp1", user1,  true, false,new HashSet<>(), new HashSet<>());
            Room room2 = new Room("temp2", user2,  true, false,new HashSet<>(), new HashSet<>());
            Room room3 = new Room("temp3", user3,  true, false,new HashSet<>(), new HashSet<>());
